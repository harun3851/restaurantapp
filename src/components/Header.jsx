      ...
      {/*desktop & tablet*/}
        ...
        <div className=" flex items-center gap-8">
          <ul className="flex items-center gap-8 ">
            ...
            <li classNam e="text-base text-textColor hover:text-headingColor duration-100 
          ...
          <div className="relative flex items-center justify-center">
            ...
            justify-center">
              ...
              <img src={Avatar} className="w-10 min-w-[40px] h-10 min-h-[40px] drop-shadow-md " alt="userprofile"></img>
          </div>
          </div>
     {/*mobile*/}
